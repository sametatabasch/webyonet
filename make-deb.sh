...
REQUIRED_FILES=("sitekaldir.sh" "webyonet-config.sh" "webyonet_menu.sh" "change_domain.sh" "backupToYandex.sh" "create_user_and_dirs.sh" "set_nginx_conf.sh" "set_apache_conf.sh" "last_steps.sh" "nginx_site.conf" )
